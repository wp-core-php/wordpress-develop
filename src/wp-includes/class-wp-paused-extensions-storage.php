...
class WP_Paused_Extensions_Storage {
	 ...
	 * @since 5.1.0
	 *
	 * @param string $extension Optional. Plugin or theme directory name. If not provided, the clause
	 *                          returned will query sites where any extension of the same name is paused.
